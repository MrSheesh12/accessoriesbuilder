...
const CONFIG = {
  ...
  // UPDATED: Full 2025 lineup incl. Lightning + E-Transit
  vehicles: [
    { id: "f150",          label: "F-150",            beds: ["5.5ft", "6.5ft"] },
    { id: "f150Lightning", label: "F-150 Lightning",  beds: ["5.5ft", "6.5ft"] },
  ...
  items: [
    { id: "bedliner", name: "Spray\u2011in Bedliner", category: "protection",
      desc: "In\u2011house spray liner for trucks. Lifetime warranty.",
      image: "assets/spray-in-bedliner.png", tags: ["bedliner", "spray"], compute: "bedliner" },

    // UPDATED fits: add f150Lightning + etransit where appropriate
    { id: "tint", name: "Front Window Tint (Carbon)", category: "protection",
      parts: 280, laborHours: 0, image: "assets/retronotify.png",
      desc: "Carbon film on front doors. Lifetime warranty.",
      tags: ["tint", "carbon"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick","bronco","broncoSport","explorer","expedition","escape","edge","mustang","machE","transit","etransit"] },

    { id: "tint_ceramic", name: "Front Window Tint (Ceramic)", category: "protection",
      parts: 340, laborHours: 0, image: "assets/retronotify.png",
      desc: "Ceramic film with superior heat rejection.",
      tags: ["tint", "ceramic"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick","bronco","broncoSport","explorer","expedition","escape","edge","mustang","machE","transit","etransit"] },

    { id: "ppf", name: "Paint Protection Film Package", category: "protection",
      parts: 1200, laborHours: 0, image: "assets/retronotify.png",
      desc: "Partial hood + fenders + headlights. Self\u2011healing film.",
      tags: ["ppf", "clear-bra"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick","bronco","broncoSport","explorer","expedition","escape","edge","mustang","machE","transit","etransit"] },

    { id: "steps", name: "AMP PowerSteps", category: "exterior",
      parts: 1400, laborHours: 1.2, image: "assets/amp-powersteps.png",
      desc: "Automatic retracting steps.",
      tags: ["amp", "running boards"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick","bronco","explorer","expedition"] },

    { id: "bakflip", name: "BAKFlip MX4 Tonneau", category: "exterior",
      image: "assets/b69bcb44-92b9-4844-8dd0-74d61a90b037.png",
      desc: "Aluminum tri\u2011fold, matte finish.",
      tags: ["tonneau", "hard-fold"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick"],
      compute: "mx4" },

    { id: "retraxt", name: "Retrax PRO XR", category: "exterior",
      image: "assets/retraxpro.png",
      desc: "Aluminum retractable with T\u2011slot rails.",
      tags: ["tonneau", "retractable"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick"],
      compute: "retrax" },

    { id: "mats", name: "All\u2011Weather Floor Mats", category: "interior",
      parts: 225, laborHours: 0, image: "assets/floor-mats.png",
      desc: "Custom\u2011fit mats to trap mud/snow.",
      tags: ["floor", "mats"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick","bronco","broncoSport","explorer","expedition","escape","edge","mustang","machE","transit","etransit"] },

    { id: "katzkin", name: "Katzkin Leather Upgrade", category: "interior",
      parts: 2500, laborHours: 0, image: "assets/retronotify.png",
      desc: "Basic Katzkin package installed.",
      tags: ["leather", "katzkin"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick","bronco","explorer","expedition","mustang"] },

    { id: "subwoofer", name: "Subwoofer Upgrade", category: "interior",
      parts: 1200, laborHours: 0, image: "assets/retronotify.png",
      desc: "Clean bass, integrated wiring.",
      tags: ["audio", "sub"],
      fits: ["f150","f150Lightning","superduty","ranger","maverick","bronco","broncoSport","explorer","expedition","escape","edge","mustang","machE","transit","etransit"] },

    { id: "leveling_half", name: "ReadyLIFT Leveling (Half\u2011ton)", category: "performance",
      parts: 650, laborHours: 1.5, image: "assets/7a6f71e5-6692-47d5-ad75-b35514b60a8c.png",
      desc: "2\" front level incl. alignment.",
      tags: ["leveling"], fits: ["f150"] },

    { id: "leveling_hd", name: "ReadyLIFT Leveling (HD)", category: "performance",
      parts: 750, laborHours: 1.5, image: "assets/a4cd8cfa-5d0e-48ab-84b6-da4437837d6a.png",
      desc: "2\" front level incl. alignment.",
      tags: ["leveling"], fits: ["superduty"] },
  ],
...
function priceOf(it) {
  ...
  if (it.compute === "bedliner") {
    // $595 short, $650 long (F-150/Lightning 5.5 vs 6.5; Super Duty 6.75 vs 8.0)
    if (vehicleId === "f150" || vehicleId === "f150Lightning") return (bed === "6.5ft") ? 650 : 595;
    if (vehicleId === "superduty") return (bed === "8ft") ? 650 : 595;
    return 595;
  }
  if (it.compute === "mx4") {
    // BAKFlip MX4 parts + ~1.0h labor
    let parts = 1050;
    if (vehicleId === "f150" || vehicleId === "f150Lightning") parts = (bed === "6.5ft") ? 1199.99 : 1050;
  ...
  if (it.compute === "retrax") {
    // Retrax PRO XR parts + ~2.0h labor
    let parts = 2249.99;
    if (vehicleId === "f150" || vehicleId === "f150Lightning") parts = (bed === "6.5ft") ? 2349.99 : 2249.99;
...
// Fitment: if item has fits array, require selected vehicle to be in it
...
if (els.exportBtn) {
  els.exportBtn.addEventListener("click", () => {
    ...
    const payload = {
      ...
      finance: state.finance.enabled ? { ...state.finance } : { enabled: false },
